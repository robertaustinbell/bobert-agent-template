#!/usr/bin/env python3
"""Generate Agent Ops index.md from active doctrine frontmatter.

The doctrine pages are canonical. index.md is a deterministic retrieval view.
"""
...
def main() -> int:
    ...
    if args.check:
        ...
        if current != generated:
            ...
            return 1
        print("index.md matches active doctrine frontmatter")
        return 0
