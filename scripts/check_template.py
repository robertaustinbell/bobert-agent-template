...
required=['README.md','ADOPT.md','CUSTOMIZE.md','FIRST-WEEK.md','FIELD-TESTING.md','CONTRIBUTING.md','RUNTIMES.md','OPTIONAL-TOOLS.md','SECURITY.md','.github/ISSUE_TEMPLATE/concept-field-test.yml','.github/ISSUE_TEMPLATE/idea-proposal.yml','.github/ISSUE_TEMPLATE/adoption-runtime-problem.yml','.github/PULL_REQUEST_TEMPLATE.md','.github/workflows/validate.yml','SOUL.md','GOVERNANCE.md','LINEAGE.md','SYNC.md','LICENSE','index.md','skills/README.md','skills/agent-prompt-design/SKILL.md','skills/deterministic-evidence-automation/SKILL.md','skills/authority-effect-contracts/SKILL.md','skills/authority-effect-contracts/scripts/contracts.py','skills/authority-effect-contracts/scripts/test_contracts.py','skills/authority-effect-contracts/references/schemas/authority-manifest-v1.schema.json','skills/authority-effect-contracts/references/schemas/external-effect-receipt-v1.schema.json']
...
required_fragments={
 ...
 'skills/README.md':['portable, sanitized procedures','does **not** mean they are installed, enabled, connected to tools, or granted authority','[`agent-prompt-design`](agent-prompt-design/SKILL.md)','[`deterministic-evidence-automation`](deterministic-evidence-automation/SKILL.md)','Private paths, case histories, live capability state, credentials, schedules, domain records, and standing permissions are excluded'],
 ...
 'skills/deterministic-evidence-automation/SKILL.md':['deterministic code collects, normalizes, bounds, validates, and receipts evidence','Missing means unknown, never empty','monitoring may not silently rewrite the acceptance standard','Audit two properties separately'],
